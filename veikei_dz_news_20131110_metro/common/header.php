...
<div id="toptb" class="cl"> 
  ...
  <div class="wp">
    ...
    <div class="y"> 
      ...
      <a href="home.php?mod=spacecp&ac=credit&showcredit=1" id="extcreditmenu"{if !$_G[setting][bbclosed]} onMouseOver="delayShow(this, showCreditmenu);" class="showmenu"{/if}>{lang credits}: $_G[member][credits]</a> <span class="pipe">|</span><a href="home.php?mod=spacecp&ac=usergroup" id="g_upmine" class="showmenu" onMouseOver="delayShow(this, showUpgradeinfo)"> $_G[group][grouptitle]</a> 
      <!--
        --> 
...
<div id="hd">
  <div class="wp">
    <div class="hdc cl"> 
      ...
      <!--{subtemplate common/vk_top_search_sim}--> 
    </div>
  </div>
  <div id="nv">
    <ul>
  ...
  <script type="text/javascript" src="{$_G[style][styleimgdir]}/nv.js"> </script> 
